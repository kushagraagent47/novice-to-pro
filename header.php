    ...
    <div class="header-content-wrapper">
        <form class="search-bar w-search notification-list friend-requests">
            <div class="form-group with-button">
                <input id="search" placeholder="Search here people or questions..." type="text">
                </div>
                <div id="display"></div>
        </form>
        ...
        <div class="control-block">
            ...
            <div class="control-icon more has-items">
                <svg class="olymp-happy-face-icon" id="step7">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <a href="#" class="view-all bg-blue"></a>
                </div>
            </div>
            <?php
                            $message_count = 0;
            ...
            <div class="control-icon more has-items">
                <svg class="olymp-chat---messages-icon" id="step8">
            ...
            <div class="control-icon more has-items">
                <svg class="olymp-thunder-icon" id="step9">
                            ...
                            <form action="header.php" method="post" class="form-group with-button custom-status">
                                ...
                                <button name="status_submit" class="bg-purple">
                                    <svg class="olymp-check-icon">
                                        <use xlink:href="icons1/icons.svg#olymp-check-icon"></use>
                                    </svg>
                                </button>
                            </form>
