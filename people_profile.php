					...
					<div class="top-header-thumb">
						...
						<div class="top-header-author">
							...
							<div class="author-content">
								<a href="#" class="h3 author-name"><?php echo $_GET['profile_username']; ?></a>
...
<?php } ?>
						...
						<div class="control-block-button">
							...
							<a href="chatting.php?user=<?php echo $profile_username;?>" class="btn btn-control bg-purple">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active inline-items" data-toggle="tab" href="#home-1" role="tab" aria-expanded="true">
								...
								<span>Ask <?php echo $_GET['profile_username'];?></span>
							</a>
						</li>
...
<div class="ui-block">
			...
			<div class="ui-block">
				...
				$query_blog="SELECT * FROM blog WHERE username = '$profile_username' ORDER BY id DESC LIMIT 15";
				$results_blog = mysqli_query($conn,$query_blog);
				while ($row_blog = mysqli_fetch_assoc($results_blog)) {
				...
				?>
					<li>
						<article class="hentry post">
							...
							<p><?php echo substr($row_blog['blog_post'],0,50); ?><a href="answer.php"> Read more...</a> </p>
