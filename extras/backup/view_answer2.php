...
$query="SELECT * FROM answers WHERE answer_id = '$ques_id'";
$results = mysqli_query($conn,$query);
while ($row = mysqli_fetch_assoc($results)) {
        $answer = $row['answer'];

        $answered_by = $row['answered_by'];
        $ques_id1 = $row['ques_id'];
}
?>
<?php
$query1="SELECT * FROM questions WHERE ques_id = '$ques_id1'";
$results1 = mysqli_query($conn,$query1);
while ($row1 = mysqli_fetch_assoc($results1)) {
        $question = $row1['question'];
        $asked_by = $row1['asked_by'];
}
?>
		...
		<div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-xs-12">
			<div class="ui-block">
				<article class="hentry blog-post single-post single-post-v3">
					...
					<h3 class="title"><b><?php echo $question;?></b><br></h3>
...
$query="SELECT * FROM questions WHERE answer != '' ORDER BY RAND() LIMIT 4";
$results = mysqli_query($conn,$query);
while ($row = mysqli_fetch_assoc($results)) {
	?>
						<div class="post-content">
							...
							<a class="h4 post-title"<?php echo ' href="view_answer.php?question=' . $row['question'] .  '&asked_by=' .$row['asked_by']  . '&ques_id=' .$row['ques_id'].'">'?><?php echo substr($row['question'],0,33); ?>...</a>
