...
<div class="container" data-step="1" data-intro="This is a tooltip!">
	<div class="row display-flex">
		...
		<div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-xs-12">
				...
				<ul class="nav nav-tabs" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#home" role="tab">
							<svg class="olymp-login-icon"><use xlink:href="icons1/icons.svg#olymp-login-icon"></use></svg>
						</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#profile" role="tab">
							<svg class="olymp-register-icon"><use xlink:href="icons1/icons.svg#olymp-register-icon"></use></svg>
						</a>
					</li>
				</ul>
			...
			<a href="fb_signup.php"  class="btn btn-lg bg-facebook full-width btn-icon-left"><i class="fa fa-facebook" aria-hidden="true"><div class="g-signin2" data-onsuccess="onSignIn"></div>
