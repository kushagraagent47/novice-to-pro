			...
			<ul class="left-menu">
				<li>
					<a href="#" class="js-sidebar-open">
						<svg class="olymp-menu-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="OPEN MENU"><use xlink:href="icons1/icons.svg#olymp-menu-icon"></use></svg>
					</a>
				</li>
				<li>
					<a href="newsfeed.php">
						<svg class="olymp-newsfeed-icon left-menu-icon" data-toggle="tooltip" data-placement="right"   data-original-title="NEWSFEED"><use xlink:href="icons1/icons.svg#olymp-newsfeed-icon"></use></svg>
					</a>
				</li>
				<li>
					<a href="find_friends.php">
						<svg class="olymp-happy-faces-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="Find People"><use xlink:href="icons1/icons.svg#olymp-happy-faces-icon"></use></svg>
					</a>
				</li>

				<li>
					<a href="user_following.php">
						<svg class="olymp-cupcake-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="Following"><use xlink:href="icons1/icons.svg#olymp-cupcake-icon"></use></svg>
					</a>
				</li>
				<li>
					<a href="user_followers.php">
						<svg class="olymp-stats-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="Followers"><use xlink:href="icons1/icons.svg#olymp-stats-icon"></use></svg>
					</a>
				</li>
				<li>
					<a href="music.php">
						<svg class="olymp-headphones-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="MUSIC&PLAYLISTS"><use xlink:href="icons1/icons.svg#olymp-headphones-icon"></use></svg>
					</a>
				</li>
				<li>
					<a href="music.php">
						<svg class="olymp-manage-widgets-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="Manage Widgets"><use xlink:href="icons1/icons.svg#olymp-manage-widgets-icon"></use></svg>
					</a>
				</li>
			</ul>
		</div>
	...
	<div class="fixed-sidebar-left sidebar--large" id="sidebar-left-1">
		...
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="left-menu">
				<li>
					<a href="#" class="js-sidebar-open">
						<svg class="olymp-close-icon left-menu-icon"><use xlink:href="icons1/icons.svg#olymp-close-icon"></use></svg>
				...
				<li>
					<a href="find_friends.php">
						<svg class="olymp-happy-faces-icon left-menu-icon"  data-toggle="tooltip" data-placement="right"   data-original-title="FRIEND GROUPS"><use xlink:href="icons1/icons.svg#olymp-happy-faces-icon"></use></svg>
...
<?php $username = $_SESSION['username'];?>
		<div class="mCustomScrollbar" data-mcs-theme="dark">
			<ul class="chat-users">
			<?php
			$query_friends="SELECT * FROM followers WHERE user1 = '$username' AND following != '$username'";
				...
				<li class="">
					<div class="author-thumb">
						<a <?php echo ' href="chatting.php?profile_username=' . $row_friends1['username'] . '"'?>>
			...
			<ul class="chat-users">
				<li class="inline-items js-chat-open">
					...
					<div class="more"><svg class="olymp-three-dots-icon"><use xlink:href="icons1/icons.svg#olymp-three-dots-icon"></use></svg>
						...
						<ul class="more-icons">
							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="START CONVERSATION" class="olymp-comments-post-icon"><use xlink:href="icons1/icons.svg#olymp-comments-post-icon"></use></svg>
							</li>

							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="ADD TO CONVERSATION" class="olymp-add-to-conversation-icon"><use xlink:href="icons1/icons.svg#olymp-add-to-conversation-icon"></use></svg>
							</li>

							<li>
								<svg data-toggle="tooltip" data-placement="top" data-original-title="BLOCK FROM CHAT" class="olymp-block-from-chat-icon"><use xlink:href="icons1/icons.svg#olymp-block-from-chat-icon"></use></svg>
							</li>
						</ul>
