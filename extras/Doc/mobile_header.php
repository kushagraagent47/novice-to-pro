    ...
    <ul class="nav nav-tabs mobile-app-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#notification" role="tab">
                <div class="control-icon has-items">
                    <svg class="olymp-thunder-icon"><use xlink:href="icons1/icons.svg#olymp-thunder-icon"></use></svg>
...
$pro_n3 = $row_ans1['asked_by'];
               ...
               <li class="message-unread">
                            ...
                            <div class="notification-event">
                                <a class="h6 notification-friend"<?php echo ' href="answer.php?question=' . $row_ans1['question'] .  '&asked_by=' .$row_ans1['asked_by']  . '&ques_id=' .$row_ans1['ques_id'].'">'?><?php echo $row_ans1['asked_by'];?> asked you a question</a>
                                <?php
